...
var actionList = [
        ...
        [   0, 'toggle-overview'       ,   _('Show Activities Overview'),                 true,  'view-grid-symbolic',     false],
        ...
        [   1, 'prev-workspace'        ,   _('Previous Workspace'),                       true,   horizontal ? 'go-previous-symbolic': 'go-up-symbolic'  , false],
        ...
        [   1, 'next-workspace'        ,   _('Next Workspace'),                           true,   horizontal ? 'go-next-symbolic'    : 'go-down-symbolic', false],
        ...
        [   1, 'close-win'             ,   _('Close window'),                             true,  'window-close-symbolic', true],
        [   1, 'maximize-win'          ,   _('Maximize window (toggle)'),                 true,  'window-maximize-symbolic', true],
        [   1, 'minimize-win'          ,   _('Minimize window'),                          true,  'window-minimize-symbolic', true],
        [   1, 'fullscreen-win'        ,   _('Fullscreen window (toggle)'),               true,  'view-fullscreen-symbolic', true],
        [   1, 'fullscreen-on-empty-ws',   _('Fullscreen window on New WS (toggle)'),     true,  'view-fullscreen-symbolic', true],
        [   1, 'above-win'             ,   _('Always on Top window (toggle)'),            true,  'go-top-symbolic', true],
        [   1, 'stick-win'             ,   _('Always on Visible WS window (toggle)'),     true,  'view-pin-symbolic', true],
        ...
        [   1, 'open-new-window'       ,   _('Open New window (if supported)'),           false,  'media-playback-start-symbolic', true],
        [   1, 'unminimize-all-ws'     ,   _('Unminimize all windows (workspace)'),       true,  'window-restore-symbolic', true],

        [null, 'win-control-submenu'   ,   _('↓ Windows - Relocations'),                  true,  'focus-windows-symbolic', false],
        ...
        [   1, 'lock-screen'           ,   _('Lock Screen'),                              true,  'changes-prevent-symbolic', false],
        ...
        [   1, 'volume-up'             ,   _('Volume Up'),                                true,  'audio-volume-high-symbolic', false],
        [   1, 'volume-down'           ,   _('Volume Down'),                              true,  'audio-volume-low-symbolic', false],
        [   1, 'mute-sound'            ,   _('Mute Audio (toggle)'),                      true,  'audio-volume-muted-symbolic', false],
        [   1, 'mpris-play-pause'      ,   _('Media key - Play/Pause'),                   true,  'media-playback-start-symbolic', false],
        [   1, 'mpris-next'            ,   _('Media key - Next Track'),                   true,  'media-skip-forward-symbolic', false],
        [   1, 'mpris-prev'            ,   _('Media key - Previous Track'),               true,  'media-skip-backward-symbolic', false],
