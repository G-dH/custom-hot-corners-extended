...
class WindowThumbnail extends St.BoxLayout {
    _init(metaWin, parent, properties) {
        ...
        this._initTmbHeight = properties.height;
        this._minimumHeight = Math.floor(5 / 100 * global.display.get_monitor_geometry(global.display.get_current_monitor()).height);
        this._scrollTimeout = properties.actionTimeout;
        this._positionOffset = properties.thumbnailsOnScreen;
        ...
        if (properties.minimize) {
            ...
            metaWin.set_icon_geometry(iconGeometry);
            metaWin.minimize();
        }
