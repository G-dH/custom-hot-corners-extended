...
const horizontal = shellVersion >= 40 && !Utils.isSupportedExtensionDetected('VerticalWS');
const prevWS = horizontal ? _('Left') : _('Up');
const nextWS = horizontal ? _('Right') : _('Down');
...
var actionList = [
    ...
    [1,    'prev-workspace',              _('Previous Workspace'),                      false,   prevIcon,                                    false],
    ...
    [1,    'reorder-ws-prev',             _(`Reorder Workspace - ${prevWS}`),            true,  prevIcon,                                     false],
    ...
    [1,    'toggle-overview-app',         _('Toggle Overview - App Windows'),            false, 'focus-windows-symbolic',                     true],
    ...
    [1,    'stick-win',                   _('Always on Visible Workspace (toggle)'),    false,  'view-pin-symbolic',                           true],
    ...
    [1,    'move-win-to-prev-new-ws',     _('Move Window to New workspace Prev'),        true,  prevIcon,                                      true],
    [1,    'move-win-to-next-ws',         _('Move Window to Next workspace'),            true,  nextIcon,                                      true],
    [1,    'move-win-to-next-new-ws',     _('Move Window to New workspace Next'),        true,  nextIcon,                                      true],
    [1,    'move-app-to-prev-ws',         _('Move App windows to Prev Workspace'),       true,  prevIcon,                                      true],
    ...
    [1,    'open-panel-system-menu',      _('Open Panel System Menu'),                   true,  'open-menu-symbolic',                         false],
